...
let resultadoM = (nota1 + nota2 + nota3 + nota4) / 4;
      
      if (resultadoM == 0) {
        mensagem = `Infelizmente você zerou a prova ):`;
      }
      else if (resultadoM >= 0.1 && resultadoM <= 3){
        mensagem = `Caramba, deu ruim, você obteve média ${resultadoM}! Estude mais e tente novamente!`;
      }
      else if (resultadoM >= 3.1 && resultadoM <= 5.9){
        mensagem = `Você obteve media ${resultadoM}! Falta pouco para a média` ;
      } 
      else if (resultadoM >= 6 && resultadoM <= 7){
        mensagem = `Você esta na média com ${resultadoM}` ;
      }
      else if (resultadoM >= 7.1 && resultadoM <= 9.9){
        mensagem = `Notão! Sua média é ${resultadoM}!` ;
      }
      else if (resultadoM == 10){
